...
data class PeerStats(
    ...
    companion object : XdrElementDecoder<PeerStats> {
        override fun decode(stream: XdrInputStream): PeerStats {
            ...
            val messagesRead = Uint64.decode(stream)
            val messagesWritten = Uint64.decode(stream)
            val bytesRead = Uint64.decode(stream)
            val bytesWritten = Uint64.decode(stream)
            val secondsConnected = Uint64.decode(stream)
            val uniqueFloodBytesRecv = Uint64.decode(stream)
            val duplicateFloodBytesRecv = Uint64.decode(stream)
            val uniqueFetchBytesRecv = Uint64.decode(stream)
            val duplicateFetchBytesRecv = Uint64.decode(stream)
            val uniqueFloodMessageRecv = Uint64.decode(stream)
            val duplicateFloodMessageRecv = Uint64.decode(stream)
            val uniqueFetchMessageRecv = Uint64.decode(stream)
            val duplicateFetchMessageRecv = Uint64.decode(stream)
            return PeerStats(
                id,
                versionStr,
                messagesRead,
